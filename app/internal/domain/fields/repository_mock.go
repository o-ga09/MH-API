...
//			GetFunc: func(ctx context.Context, monsterId string) (Fields, error) {
//				panic("mock out the Get method")
//			},
//			RemoveFunc: func(ctx context.Context, monsterId string) error {
//				panic("mock out the Remove method")
//			},
//			SaveFunc: func(ctx context.Context, m Field) error {
...
// Get calls GetFunc.
func (mock *RepositoryMock) Get(ctx context.Context, monsterId string) (Fields, error) {
	if mock.GetFunc == nil {
...
// Save calls SaveFunc.
func (mock *RepositoryMock) Save(ctx context.Context, m Field) error {
